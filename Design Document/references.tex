...
\begin{thebibliography}{10}
    ...
    \bibitem{z3}\textit{Amazon Kinesis Firehose - Developer guide}, 1st ed. Amazon Web Services, Inc, 2016, p. 2.
  	...
  	\bibitem{w1}"Boto 3 Documentation for DynamoDB table Implementation", \textit{Amazon Web Services,Inc.}, 2016. [Online]. Available: 	   
https://boto3.readthedocs.io/en/latest/guide/dynamodb.htmlusing-an-existing-table. [Accessed: 24-Mar- 2017].
\bibitem{w2}"Amazon QuickSight User Guide", \textit{Amazon Web Services, Inc.}, 2016. [Online]. Available:
